...
| Step | Action |
|------|--------|
| 1 | Use **[makesense.ai](https://www.makesense.ai)** (web-based, no install) — this is the tool used for this project's annotations |
| 2 | Open `data/images/val/` and draw bounding boxes on ≥ 50 images |
| 3 | Export as **COCO JSON** |
| 4 | Save to `data/annotations/instances_manual.json` |
