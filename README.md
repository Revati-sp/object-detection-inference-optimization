...
### Video Inference (100 frames, 640×640)

> Results from `results/video_benchmark.csv`.

| Model | Backend | Frames | Avg Latency/Frame (ms) | Avg FPS |
|-------|---------|--------|----------------------|---------|
| YOLOv8n | PyTorch | 100 | 32.10 | 31.2 |
| YOLOv8n | TorchScript | 100 | 44.97 | 22.2 |
| YOLOv8n | ONNX Runtime | 100 | 37.23 | 26.9 |
| YOLOv5s | PyTorch | 100 | 46.12 | 21.7 |
| YOLOv5s | TorchScript | 100 | 64.27 | 15.6 |
| YOLOv5s | ONNX Runtime | 100 | 64.50 | 15.5 |
