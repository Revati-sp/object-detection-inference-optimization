...
class Settings(BaseSettings):
    ...
    YOLOV8_TENSORRT_PATH: str = "weights/yolov8n.engine"
    YOLOV5_TORCHSCRIPT_PATH: str = "weights/yolov5s.torchscript"
    YOLOV5_ONNX_PATH: str = "weights/yolov5s.onnx"
    YOLOV5_TENSORRT_PATH: str = "weights/yolov5s.engine"

    # RT-DETR weights (Ultralytics RTDETR; auto-downloaded on first use)
    RTDETR_WEIGHTS: str = "rtdetr-l.pt"
    RTDETR_ONNX_PATH: str = "weights/rtdetr-l.onnx"
    RTDETR_TENSORRT_PATH: str = "weights/rtdetr-l.engine"
